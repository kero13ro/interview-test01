...
const ChatButton = (props: ChatButtonProps) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={44} height={44} fill="none" {...props}>
      <path
        fill={`url(#ChatButton${key}_svg__a)`}
        d="M.5 22C.5 10.126 10.126.5 22 .5S43.5 10.126 43.5 22 33.874 43.5 22 43.5.5 33.874.5 22Z"
      />
      <path
        stroke={`url(#ChatButton${key}_svg__b)`}
        d="M.5 22C.5 10.126 10.126.5 22 .5S43.5 10.126 43.5 22 33.874 43.5 22 43.5.5 33.874.5 22Z"
      />
      <path
        fill={`url(#ChatButton${key}_svg__c)`}
        fillRule="evenodd"
      ...
      />
      <defs>
        <linearGradient id="ChatButtonDisable_svg__a" x1={22} x2={22} y1={0} y2={44} gradientUnits="userSpaceOnUse">
          <stop stopColor="#393939" />
          <stop offset={1} stopColor="#242424" />
        </linearGradient>
        <linearGradient id="ChatButtonDisable_svg__b" x1={22} x2={22} y1={0} y2={44} gradientUnits="userSpaceOnUse">
          <stop stopColor="#686868" />
          <stop offset={0.42} stopColor="#313131" />
        </linearGradient>
        <linearGradient id="ChatButtonDisable_svg__c">
          <stop stopColor="#3E3E3E" />
        </linearGradient>
        <linearGradient id="ChatButtonEnable_svg__a" x1="22" y1="0" x2="22" y2="44" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1A5732" />
          <stop offset="1" stopColor="#0E3A22" />
        </linearGradient>
        <linearGradient id="ChatButtonEnable_svg__b" x1="22" y1="0" x2="22" y2="44" gradientUnits="userSpaceOnUse">
          <stop stopColor="#49865F" />
          <stop offset="0.42" stopColor="#1A472D" />
        </linearGradient>
        <linearGradient id="ChatButtonEnable_svg__c">
